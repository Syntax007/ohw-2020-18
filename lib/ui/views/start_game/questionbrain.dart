...
class TeenTruthBrain {
  ...
  List<Question> _teenTruthBank = [
    ...
    Question('What\'s the dumbest thing you ever said or did, around a boy/girl you liked?', true),
...
class TeenDareBrain {
  ...
  List<Question> _teenDareBank =[
    ...
    Question('Go outside and yell Merry Christmas at the top of your lungs',true),
...
class AdultTruthBrain {
  ...
  List<Question> _adultTruthBank =[
    ...
    Question('What’s the craziest thing you’ve done in front of a mirror?',true),
...
class AdultDareBrain {
  ...
  List<Question> _adultDareBank =[
    Question(' Sniff the breath of everyone in the room and say who has the worst',true),
    ...
    Question('Have another player blindfold you until it\'s your turn again ',true),
