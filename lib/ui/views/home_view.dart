...
import 'package:truthordare/ui/views/add_dare_view.dart';
import 'package:truthordare/ui/views/add_truth_view.dart';
            ...
            children: <Widget>[
              ...
              MainButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => AddTruth()),
                  );
                },
              ),
              Spacer(),
